...
/**
 * Hoardersoft popup menu component. Main advantage over a JPopupMenu is the ability
 ...
 * @author Richard Kent
 */
public class HSPopupMenu extends JPopupMenu {
     ...
     */
    public HSPopupMenu(HSStatusBarListener statusBarListener) {
        super();
     ...
     */
    public HSPopupMenu(String name) {
        super(name);
     ...
     */
    public HSPopupMenu(String name, HSStatusBarListener statusBarListener) {
        super(name);
    ...
    private boolean anyIcons() {
        int nMenuItems = getComponentCount();
