...
package org.zephyrsoft.util.easyprint;
...
/**
 * A utility class for printing HTML formated text and plain text (as well as rtf).
 *
 * @author		Leander Eyer
 * @version		1.01
 */
public class EasyPrint implements Runnable {
	 ...
	 * @param printJobName		Name of the print job
	 */
	public static void printPlain(String content, String printJobName, boolean useFixedWidthFont) {
	 ...
	 *
	 * @param content			rtf code that should be printed
	 * @param printJobName		Name of the print job
	 */
	 ...
	 *
	 * @param content			url for the plain text that should be printed
	 * @param printJobName		Name of the print job
	 */
	 ...
	 *
	 * @param content			url for the rtf code that should be printed
	 * @param printJobName		Name of the print job
	 */
	 ...
	 *
	 * @param content			url to the html code that should be printed
	 * @param printJobName		Name of the print job
	 */
	 ...
	 *
	 * @param content			input stream for the plain textthat should be printed
	 * @param printJobName		Name of the print job
	 */
	 ...
	 *
	 * @param content			input stream for the rtf code that should be printed
	 * @param printJobName		Name of the print job
	 */
	 ...
	 *
	 * @param content			input stream for the html code that should be printed
	 * @param printJobName		Name of the print job
	 */
	...
	/**
	 * Create the Printer. It receives a preconfigured JTextPane instance, with a loaded document and an EditorKit
	 * installed which returns ExposedViews.
	 *
