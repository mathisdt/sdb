...
/**
 * The JTextPane enhanced with Printablility (we essentially implement the Print Method and
...
class PrintableTextPane extends JTextPane implements Printable {
	...
	/**
	 * Since all the work is done in the PageFactory, we just simply print the component.
	 *
